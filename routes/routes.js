...
const courseAchivemnetsRouteHandler = require("../modules/courseAchivements/router");
...
class Routes {
	...
	appRoutes() {
		...
		this.app.use("/api/course/achivements", jwt.protect, courseAchivemnetsRouteHandler);
	}
	routesConfig() {
		this.appRoutes();
	}
