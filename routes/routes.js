...
const courseAssesmentQuestionRouteHandler = require("../modules/courseAssesmentQuestion/router");
...
class Routes {
	...
	appRoutes() {
		...
		this.app.use("/api/course/task/assesments/question", jwt.protect, courseAssesmentQuestionRouteHandler);
